...
- Queen's Wharf Lighthouse (Fleet Street)
...
- The Little House (in St. Clair West Village)
- Half House (St. Patrick Street)
- Cube House
- Wood Cake House
- Elephant House
...
- University Ave status (TODO: expand)
- Queen's Park statues (TODO: expand)
...
TODO: how many are there even?
  → Ontario Heritage Trust
    → https://maps.heritagetrust.on.ca/explore?view=plaques
  → Heritage Toronto
    → https://www.heritagetoronto.org/explore/?content-type=gallery&qid=1
    → https://www.heritagetoronto.org/programs/plaques/
    → https://torontoplaques.ca/Menu_Index
...
- Bluffer's Park (TODO: confirm name)
- Ireland Park
- Guild Park
...
- Squirrel (TODO: more specific)
- Raccoon
- Pigeon (TODO: more specific)
- TODO: more native fauna
